...
@implementation SegmentCustomStyleManager
...
- (void)buttonPressed:(UIButton *)sender
{
    ...
    if (_delegate &&[_delegate respondsToSelector:@selector(segmentCustomView:index:)]){
        [self.delegate segmentCustomView:self index:sender.tag - 10];
    }
}
