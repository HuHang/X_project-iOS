...
- (void)viewDidAppear:(BOOL)animated{
    ...
    [PCMBProgressHUD showLoadingTipsInView:self.view title:nil detail:self.messageString withIsAutoHide:YES];
...
- (void)imagePickerControllerDidCancel:(UIImagePickerController *)picker{
    [PCMBProgressHUD showLoadingTipsInView:self.view title:@"提示" detail:@"抱歉，您必须完成绑定操作" withIsAutoHide:YES];
}
